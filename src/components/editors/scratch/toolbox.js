...
export default () => ([
	{
		name            : s('scratch.toolbox.category.input'),
		colour          : '#7fd5f0',
	...
	{
		name            : s('scratch.toolbox.category.output'),
		colour          : '#f580c5',
	...
	{
		name            : s('scratch.toolbox.category.control'),
		colour          : '#FFAB19',
	...
	{
		name            : s('scratch.toolbox.category.operators'),
		colour          : '#40BF4A',
	...
	{
		name            : s('scratch.toolbox.category.variables'),
		colour          : '#FF8C1A',
		secondaryColour : '#DB6E00',
		custom          : 'VARIABLE'
	},
	{
		name            : s('scratch.toolbox.category.procedures'),
		colour          : '#FF6680',
