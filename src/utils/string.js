export const stringEndsWith = (string, searchString, position) => {
...
export const rTrimNumerals = string => {
	while (parseInt(string.charAt(string.length - 1), 10).toString() === string.charAt(0)) {
		string = string.substring(string.length - 1, 0)
	}
	return string
}
export const trimNumerals = (string) =>
	lTrimNumerals(rTrimNumerals(string))
export const lTrimSpaces = string => {
	while (string.charAt(0) === ' ') {
		string = string.substring(string.length, 1)
	}
	return string
}
export const rTrimSpaces = string => {
...
export const trimSpaces = string =>
	lTrimSpaces(rTrimSpaces(string))
...
export const sanitizeCPPVariableName = (name) => {
	if (!name) {
		return '_'
	}
	let newName = trimSpaces(name)
