			...
			<div className="root app">
				<style jsx>{`
					...
					@font-face {
						...
						src: url('/static/fonts/SourceCodePro-Regular.eot?#iefix') format('embedded-opentype'),
							url('/static/fonts/SourceCodePro-Regular.woff2') format('woff2'),
							url('/static/fonts/SourceCodePro-Regular.woff') format('woff'),
							url('/static/fonts/SourceCodePro-Regular.ttf') format('truetype'),
							url('/static/fonts/SourceCodePro-Regular.svg#SourceCodePro-Regular') format('svg');
						font-weight: normal;
						font-style: normal;
					}
					:global(html),
